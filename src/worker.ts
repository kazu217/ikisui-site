...
const SESSION_COOKIE = "ikisui_admin";
...
async function isValidSession(request: Request, env: Env): Promise<boolean> {
...
async function readProducts(env: Env): Promise<AffiliateProduct[]> {
